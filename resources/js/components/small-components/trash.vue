            ...
            if(confirm(this.messages.are_you_sure)){
                ...
                axios.post(' /trash/delete',{
                    ...
                    if(res.status === 200){
                        ...
                        this.trashes=this.trashes.filter(function(value){
                            return value.id!==trash.id;
                        });
