<template>
         <div class="weather-intro-1 w-full h-full bg-about flex justify-evenly items-center border-2 border-white dark:border-gray-200">
             ...
             <div class="flex flex-col p-2 justify-center">
                 ...
                 <span class="add_stroke_white text-dark-black font-poppins text-md">Today</span>
                 <span class="font-poppins font-bold text-white">feels Like {{weather.feels_like}} °C</span>
...
export default {
    ...
    methods:{
        ...
        formatWeather(value){
            ...
            // console.log(hour)
            switch (value){
                case 'clear sky':this.weather.color= hour<6||hour>17?'#333333':'#fffc0e';return hour<6||hour>17?'clear-night':'clear-day';
                case 'broken clouds':this.weather.color= hour<6||hour>17?'#333333':'#d6d6d6'; return hour<6||hour>17?'partly-cloudy-night':'partly-cloudy-day';
